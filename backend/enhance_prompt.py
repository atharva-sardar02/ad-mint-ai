#!/usr/bin/env python3
"""
Standalone CLI tool for prompt enhancement.

Usage:
    python enhance_prompt.py <input_file> [--output-dir <dir>] [--max-iterations <n>] [--threshold <score>]

Examples:
    # Basic usage - reads from prompt.txt, saves to output/prompt_traces/
    ...
    python enhance_prompt.py prompt.txt --max-iterations 5 --threshold 90
...
async def main():
    ...
    parser = argparse.ArgumentParser(
        description="Enhance prompts using two-agent iterative refinement",
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Output directory for trace files (default: output/prompt_traces/<timestamp>)"
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="gpt-4-turbo",
        help="Model for Creative Director agent (default: gpt-4-turbo)"
    )
    ...
    try:
        ...
        if args.output_dir:
            ...
            output_dir = Path("output") / "prompt_traces" / timestamp
